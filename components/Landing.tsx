  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-8 md:gap-9">
      ...
      <div className="flex w-full flex-col items-center gap-y-4 px-4 md:p-0">
        <div className="hidden w-full max-w-xl items-center justify-between rounded-full border border-base-200 bg-base-200 py-2 pl-4 pr-2 text-xl drop-shadow-md md:flex">
          <div className="flex">
          ...
          <Link
            href={'/auth'}
            className="btn-secondary btn ml-2 rounded-full normal-case drop-shadow-md"
          >
            Create my page
          </Link>
        </div>

        <div className="flex h-12 w-full max-w-xl items-center justify-between rounded-full border border-base-200 bg-base-200 py-2 pl-4 pr-2 text-base drop-shadow-md md:hidden">
          <div className="flex">
            <span>send-me-crypto.vercel.app/</span>
            <span className="opacity-50">username</span>
          </div>
